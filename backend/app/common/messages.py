...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "errors.auth.account_inactive": {
        ...
        "es": "La cuenta esta inactiva",
        "de": "Konto ist inaktiv",
        "fr": "Le compte est inactif",
        "ru": "Uchetnaya zapis neaktivna",
    },
    ...
    "errors.meals.not_found": {
        "en": "Meal not found",
        "es": "Comida no encontrada",
        "de": "Mahlzeit nicht gefunden",
        "fr": "Repas introuvable",
        "ru": "Priem pishchi ne naiden",
    },
    "errors.recommendations.not_found": {
        "en": "Recommendation not found",
        "es": "Recomendacion no encontrada",
        "de": "Empfehlung nicht gefunden",
        "fr": "Recommandation introuvable",
        "ru": "Rekomendatsiya ne naidena",
    },
    "errors.meal_plans.not_found": {
        "en": "Meal plan not found",
        "es": "Plan de comidas no encontrado",
        "de": "Ernaehrungsplan nicht gefunden",
        "fr": "Plan de repas introuvable",
        "ru": "Plan pitaniya ne naiden",
    },
    "errors.upload.not_found": {
        "en": "Upload not found",
        "es": "Carga no encontrada",
        "de": "Upload nicht gefunden",
        "fr": "Televersement introuvable",
        "ru": "Zagruzka ne naidena",
    },
    "errors.upload.invalid_filename": {
        "en": "Invalid file name",
        "es": "Nombre de archivo invalido",
        "de": "Ungueltiger Dateiname",
        "fr": "Nom de fichier invalide",
        "ru": "Nekorrektnoe imya faila",
    },
    "errors.upload.invalid_mime_type": {
        "en": "Invalid file type",
        "es": "Tipo de archivo invalido",
        "de": "Ungueltiger Dateityp",
        "fr": "Type de fichier invalide",
        "ru": "Nekorrektnyi tip faila",
    },
    "errors.upload.invalid_file_size": {
        "en": "Invalid file size",
        "es": "Tamano de archivo invalido",
        "de": "Ungueltige Dateigroesse",
        "fr": "Taille de fichier invalide",
        "ru": "Nekorrektnyi razmer faila",
    },
    "errors.upload.invalid_checksum": {
        "en": "Invalid file checksum",
        "es": "Suma de comprobacion invalida",
        "de": "Ungueltige Pruefsumme",
        "fr": "Somme de controle invalide",
        "ru": "Nekorrektnaya kontrolnaya summa faila",
    },
